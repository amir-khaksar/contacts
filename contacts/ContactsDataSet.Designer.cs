...
namespace contacts {
    ...
    public partial class ContactsDataSet : global::System.Data.DataSet {
        ...
        public partial class ContactsDataTable : global::System.Data.TypedTableBase<ContactsRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public ContactsRow AddContactsRow(string ContactName, string ContactPhone) {
            ...
            private void InitClass() {
                ...
                this.columnContactPhone.MaxLength = 255;
            }
        ...
        public partial class ContactsRow : global::System.Data.DataRow {
            ...
            public string ContactPhone {
                get {
                    try {
                        return ((string)(this[this.tableContacts.ContactPhoneColumn]));
                    }
                    catch (global::System.InvalidCastException e) {
                        throw new global::System.Data.StrongTypingException("The value for column \'ContactPhone\' in table \'Contacts\' is DBNull.", e);
                    }
                }
                set {
                    this[this.tableContacts.ContactPhoneColumn] = value;
                }
            }
            ...
            public bool IsContactPhoneNull() {
                return this.IsNull(this.tableContacts.ContactPhoneColumn);
            }
            
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public void SetContactPhoneNull() {
                this[this.tableContacts.ContactPhoneColumn] = global::System.Convert.DBNull;
            }
        }
...
namespace contacts.ContactsDataSetTableAdapters {
    ...
    public partial class ContactsTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM `Contacts` WHERE ((`ContactId` = ?) AND ((? = 1 AND `ContactName` IS " +
                "NULL) OR (`ContactName` = ?)) AND ((? = 1 AND `ContactPhone` IS NULL) OR (`Conta" +
                "ctPhone` = ?)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO `Contacts` (`ContactName`, `ContactPhone`) VALUES (?, ?)";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE `Contacts` SET `ContactName` = ?, `ContactPhone` = ? WHERE ((`ContactId` =" +
                " ?) AND ((? = 1 AND `ContactName` IS NULL) OR (`ContactName` = ?)) AND ((? = 1 A" +
                "ND `ContactPhone` IS NULL) OR (`ContactPhone` = ?)))";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::contacts.Properties.Settings.Default.ContactsConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT ContactId, ContactName, ContactPhone FROM Contacts";
            this._commandCollection[0].CommandType = global::System.Data.CommandType.Text;
            this._commandCollection[1] = new global::System.Data.OleDb.OleDbCommand();
            this._commandCollection[1].Connection = this.Connection;
            this._commandCollection[1].CommandText = "DELETE FROM `Contacts` WHERE ContactName = ?";
            this._commandCollection[1].CommandType = global::System.Data.CommandType.Text;
            this._commandCollection[1].Parameters.Add(new global::System.Data.OleDb.OleDbParameter("ContactName", global::System.Data.OleDb.OleDbType.WChar, 255, global::System.Data.ParameterDirection.Input, ((byte)(0)), ((byte)(0)), "ContactName", global::System.Data.DataRowVersion.Original, false, null));
            this._commandCollection[2] = new global::System.Data.OleDb.OleDbCommand();
            this._commandCollection[2].Connection = this.Connection;
            this._commandCollection[2].CommandText = "SELECT ContactId, ContactName, ContactPhone FROM Contacts where ContactName = ?";
            this._commandCollection[2].CommandType = global::System.Data.CommandType.Text;
            this._commandCollection[2].Parameters.Add(new global::System.Data.OleDb.OleDbParameter("ContactName", global::System.Data.OleDb.OleDbType.WChar, 255, global::System.Data.ParameterDirection.Input, ((byte)(0)), ((byte)(0)), "ContactName", global::System.Data.DataRowVersion.Current, false, null));
            this._commandCollection[3] = new global::System.Data.OleDb.OleDbCommand();
            this._commandCollection[3].Connection = this.Connection;
            this._commandCollection[3].CommandText = "INSERT INTO `Contacts` (`ContactName`, `ContactPhone`) VALUES (?, ?)";
            this._commandCollection[3].CommandType = global::System.Data.CommandType.Text;
            this._commandCollection[3].Parameters.Add(new global::System.Data.OleDb.OleDbParameter("ContactName", global::System.Data.OleDb.OleDbType.WChar, 255, global::System.Data.ParameterDirection.Input, ((byte)(0)), ((byte)(0)), "ContactName", global::System.Data.DataRowVersion.Current, false, null));
            this._commandCollection[3].Parameters.Add(new global::System.Data.OleDb.OleDbParameter("ContactPhone", global::System.Data.OleDb.OleDbType.WChar, 255, global::System.Data.ParameterDirection.Input, ((byte)(0)), ((byte)(0)), "ContactPhone", global::System.Data.DataRowVersion.Current, false, null));
            this._commandCollection[4] = new global::System.Data.OleDb.OleDbCommand();
            this._commandCollection[4].Connection = this.Connection;
            this._commandCollection[4].CommandText = "UPDATE `Contacts` SET `ContactName` = ?, `ContactPhone` = ? WHERE ContactName  = " +
                "?";
            this._commandCollection[4].CommandType = global::System.Data.CommandType.Text;
            this._commandCollection[4].Parameters.Add(new global::System.Data.OleDb.OleDbParameter("ContactName", global::System.Data.OleDb.OleDbType.WChar, 255, global::System.Data.ParameterDirection.Input, ((byte)(0)), ((byte)(0)), "ContactName", global::System.Data.DataRowVersion.Current, false, null));
            this._commandCollection[4].Parameters.Add(new global::System.Data.OleDb.OleDbParameter("ContactPhone", global::System.Data.OleDb.OleDbType.WChar, 255, global::System.Data.ParameterDirection.Input, ((byte)(0)), ((byte)(0)), "ContactPhone", global::System.Data.DataRowVersion.Current, false, null));
            this._commandCollection[4].Parameters.Add(new global::System.Data.OleDb.OleDbParameter("Original_ContactName", global::System.Data.OleDb.OleDbType.WChar, 255, global::System.Data.ParameterDirection.Input, ((byte)(0)), ((byte)(0)), "ContactName", global::System.Data.DataRowVersion.Original, false, null));
        }
        ...
        public virtual int FillBy(ContactsDataSet.ContactsDataTable dataTable, string ContactName) {
            this.Adapter.SelectCommand = this.CommandCollection[2];
            if ((ContactName == null)) {
                this.Adapter.SelectCommand.Parameters[0].Value = global::System.DBNull.Value;
            }
            else {
                this.Adapter.SelectCommand.Parameters[0].Value = ((string)(ContactName));
            }
            if ((this.ClearBeforeFill == true)) {
                dataTable.Clear();
            }
        ...
        public virtual ContactsDataSet.ContactsDataTable GetDataBy1(string ContactName) {
            this.Adapter.SelectCommand = this.CommandCollection[2];
            if ((ContactName == null)) {
                this.Adapter.SelectCommand.Parameters[0].Value = global::System.DBNull.Value;
            }
        ...
        public virtual int Delete(int Original_ContactId, string Original_ContactName, string Original_ContactPhone) {
        ...
        public virtual int Insert(string ContactName, string ContactPhone) {
            if ((ContactName == null)) {
        ...
        public virtual int Update(string ContactName, string ContactPhone, int Original_ContactId, string Original_ContactName, string Original_ContactPhone) {
            if ((ContactName == null)) {
            ...
            if ((Original_ContactName == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[4].Value = ((string)(Original_ContactName));
            }
            if ((Original_ContactPhone == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[6].Value = ((string)(Original_ContactPhone));
            }
        ...
        public virtual int DeleteQuery(string ContactName) {
        ...
        public virtual int InsertQuery(string ContactName, string ContactPhone) {
        ...
        public virtual int UpdateQuery(string ContactName, string ContactPhone, string Original_ContactName) {
            ...
            if ((Original_ContactName == null)) {
                ...
                command.Parameters[2].Value = ((string)(Original_ContactName));
            }
            global::System.Data.ConnectionState previousConnectionState = command.Connection.State;
            if (((command.Connection.State & global::System.Data.ConnectionState.Open) 
                        != global::System.Data.ConnectionState.Open)) {
